    ...
    private class MyHandler extends Handler {
        ...
        private void handleGetPreferredNetworkTypeResponse(Message msg) {
            ...
            if (ar.exception == null) {
                ...
                int settingsNetworkMode = android.provider.Settings.Public.getInt(
                        getPhone().getContext().getContentResolver(),
                        android.provider.Settings.Public.PREFERRED_NETWORK_MODE,
                ...
                if (modemNetworkMode == Phone.NT_MODE_WCDMA_PREF ||
                    ...
                    if (modemNetworkMode != settingsNetworkMode) {
                        ...
                        android.provider.Settings.Public.putInt(
                                getPhone().getContext().getContentResolver(),
                                android.provider.Settings.Public.PREFERRED_NETWORK_MODE,
                                settingsNetworkMode );
                    }
        ...
        private void resetNetworkModeToDefault() {
            android.provider.Settings.Public.putInt(getPhone().getContext().getContentResolver(),
                        android.provider.Settings.Public.PREFERRED_NETWORK_MODE,
                        MobileNetworkSettings.preferredNetworkMode );
            //Set the Modem
